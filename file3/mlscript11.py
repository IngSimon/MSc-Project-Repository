...
def predict_Q_data(input_dir_2, filename4 = "training.txt"):
       ...
       return  lam_R, stokesQ_R, mu_initial, std_initial, mu_optimized, std_optimized
...
lam_R, stokesQ_R, mu_initial, std_initial, mu_optimized, std_optimized = predict_Q_data(input_dir_2)
