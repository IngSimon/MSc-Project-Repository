###works well for all datasets

###improved for faraday thin source

###with wavelengths extension to lower values
...
#t1 = np.linspace(np.min(lam2_R), np.max(lam2_R), 1024)
t1 = np.linspace(0, np.max(lam2_R), 1024)
