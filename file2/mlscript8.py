...
lam_squared, stokesQ, stokesU = read_data(input_dir_2, "training.txt")
...
pl.plot(x, mu,color = 'red', linestyle='none', marker='.')

pl.plot(x, mu1, color = 'red', linestyle='none', marker='.')
