...
###Script generates 'complete' directory within the directory containing data
...
def predict_Q_data(input_dir_2, filename4 = "training.txt"):
       ...
       x = np.linspace(np.min(lam_squared)-0.01, np.max(lam_squared), 1024) #extend to smaller wavelengths
